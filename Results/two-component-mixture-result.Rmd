...
result <- readRDS(here::here("Results","two-component-result_new_ess_bulk.rds"))
...
pdf("two-component-mixture-log-result-new-ess-bulk-skewed.pdf", width = 18, height = 20)
...
pdf("two-component-mixture-result-new-ess-bulk-skewed.pdf", width = 18, height = 20)
grid.arrange(
