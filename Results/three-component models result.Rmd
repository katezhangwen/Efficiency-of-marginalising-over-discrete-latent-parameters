...
r1 <- sampling(here("Data", "tdata1.txt"), result, resultr)
```
...
r2 <- sampling(here("Data", "tdata2.txt"), result, resultr)
```
...
r3 <- sampling(here("Data", "tdata3.txt"), result, resultr)
```
...
r4 <- sampling(here("Data", "tdata4.txt"), result, resultr)
```
...
r5 <- sampling(here("Data", "tdata5.txt"), result, resultr)
```
