...
r1 <- sampling(here("Data", "data1.txt"), result, resultr)
```
...
r2 <- sampling(here("Data", "data2.txt"), result, resultr)
```
...
r3 <- sampling(here("Data", "data3.txt"), result, resultr)
```
...
r4 <- sampling(here("Data", "data4.txt"), result, resultr)
```
...
r5 <- sampling(here("Data", "data5.txt"), result, resultr)
```
