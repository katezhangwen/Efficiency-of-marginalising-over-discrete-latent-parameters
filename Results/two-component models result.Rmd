...
r1 <- sampling(here("Data", "data2.txt"), result, resultr)
```
...
r2 <- sampling(here("Data", "data3.txt"), result, resultr)
```
...
r3 <- sampling(here("Data", "data4.txt"), result, resultr)
```
...
r4 <- sampling(here("Data", "data5.txt"), result, resultr)
```
...
sigma = sqrt(1/prec)
```{r data5 density}
x <- as.numeric(unlist(read.table(here("Data", "data6.txt"))))
plot(density(x), main="data5")
```

```{r sampling with data5, echo=FALSE, include= FALSE}
r5 <- sampling(here("Data", "data6.txt"), result, resultr)
```
